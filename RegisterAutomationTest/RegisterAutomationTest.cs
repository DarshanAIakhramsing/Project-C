...
{
    public class RegisterAutomationTest : IDisposable
    {
        ...
        public void Driver()
        {
            ...
            using (IWebDriver driver = new ChromeDriver())
            {
                ...
                driver.FindElement(By.Name("Input.ConfirmPassword")).SendKeys("Testing123!");
                //Finds the register button and clicks on it
